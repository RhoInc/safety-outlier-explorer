...
function updateParticipantDropdown() {
    ...
    var participantDropdown = this.multiples.controls.wrap.style('margin', 0).selectAll('.control-group').style('margin', 0);
    ...
    participantDropdown.selectAll('select').style('margin-left', '3px').on('change', function (d) {
...
function smallMultiples() {
    ...
    //Initialize small multiples.
    webcharts.multiply(this.multiples.chart, this.multiples.data, 'measure_unit', this.measures);
