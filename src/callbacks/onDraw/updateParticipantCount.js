...
export default function updateParticipantCount() {
    ...
    this.participantCount.n = set(this.filtered_data.map(d => d[this.config.id_col]))
        .values()
        .length;
    this.participantCount.percentage = format('0.1%')(this.participantCount.n / this.participantCount.N);
