...
var ReactOutlierExplorer = (function (_React$Component) {
    _inherits(ReactOutlierExplorer, _React$Component);

    function ReactOutlierExplorer(props) {
        _classCallCheck(this, ReactOutlierExplorer);

        _get(Object.getPrototypeOf(ReactOutlierExplorer.prototype), 'constructor', this).call(this, props);
        this.state = {};
    }

    _createClass(ReactOutlierExplorer, [{
...
var Renderer = (function (_React$Component2) {
    ...
    _createClass(Renderer, [{
        ...
        key: 'render',
        value: function render() {
            return React.createElement(ReactOutlierExplorer, {
                id: this.props.id,
